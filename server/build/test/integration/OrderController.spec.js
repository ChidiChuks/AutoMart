...
describe('Order transaction', function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 12:
              ...
              _context6.next = 15;
              return _chai2["default"].request(_index2["default"]).patch("/api/v1/order/".concat(id, "/price")).set('x-auth', token).send({
                price: 7100000
              });
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 14:
              ...
              _context7.next = 18;
              return _chai2["default"].request(_index2["default"]).patch('/api/v1/order').set('x-auth', token);
  ...
  describe('View all orders', function () {
    ...
    regeneratorRuntime.mark(function _callee10() {
      var newUser, _ref12, rows, length, token, res;
  ...
  describe('View a single order', function () {
    ...
    regeneratorRuntime.mark(function _callee12() {
      var newUser, _ref16, rows, length, token, orderInfo, id, res;
    ...
    regeneratorRuntime.mark(function _callee15() {
      var newUser, orderInfo, id, _ref20, rows, len, token, res;
  ...
  describe('Seller and Buyer update order status', function () {
    ...
    regeneratorRuntime.mark(function _callee20() {
      var newUser, orderInfo, id, _ref26, rows, len, token, res;
  ...
  describe('deletes a cancelled order', function () {
    ...
    regeneratorRuntime.mark(function _callee25() {
      var token, cars, newOrderData, orderInfo, id, _ref33, rows, tk, res;
