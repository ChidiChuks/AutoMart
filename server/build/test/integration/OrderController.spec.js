...
describe('Order transaction', function () {
  ...
  describe('Create order', function () {
    ...
    regeneratorRuntime.mark(function _callee3() {
      var data, newAd, newUser, _ref5, rows, user, token, res;
  ...
  describe('View a single order', function () {
    ...
    regeneratorRuntime.mark(function _callee16() {
      var newUser, orderInfo, id, _ref22, rows, len, token, res;
  ...
  describe('Seller and Buyer update order status', function () {
    ...
    regeneratorRuntime.mark(function _callee21() {
      var newUser, orderInfo, id, _ref28, rows, len, token, res;
  ...
  describe('deletes a cancelled order', function () {
    ...
    regeneratorRuntime.mark(function _callee26() {
      var token, cars, newOrderData, orderInfo, id, _ref35, rows, tk, res;
