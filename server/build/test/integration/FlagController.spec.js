...
describe('Flags controller', function () {
  ...
  describe('Create a flag', function () {
    ...
    regeneratorRuntime.mark(function _callee3() {
      var data, newAd, _ref5, rows, carId, token, newFlag, res;
    ...
    regeneratorRuntime.mark(function _callee6() {
      var data, newAd, _ref10, rows, carId, token, newFlag, res;
  ...
  describe('Update a flag', function () {
    ...
    regeneratorRuntime.mark(function _callee8() {
      var _ref14, rows, flagid, user, token, res;
  ...
  describe('Admin can delete a given flag', function () {
    ...
    regeneratorRuntime.mark(function _callee16() {
      var _ref25, rows, id, user, token, res;
