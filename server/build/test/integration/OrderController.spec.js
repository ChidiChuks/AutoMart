...
describe('Order transaction', function () {
  ...
  describe('Seller update order price while status is still pending', function () {// it('should update the order price ', (done) => {
    //     UserModel.users = usersData;
  ...
  describe('View a single order', function () {// it('should return order if it is admin', (done) => {
    //     UserModel.users = usersData;
  ...
  describe('deletes a cancelled order', function () {// it('should return error 400 if seller attempts to delete an uncancelled order', (done) => {
    //     UserModel.users = usersData;
    //     const { id } = ordersData[0];
    //     ordersData[0].status = 'rejected';
    //     ordersData[0].sellerId = usersData[0].id;
