...
const _carsData = require('../carsData');

const _carsData2 = _interopRequireDefault(_carsData);
...
const _usersData = require('../usersData');
...
describe('Cars', () => {
  ...
  describe('Create Ad', () => {
    it('should return error 400 if request does not contain all required fields', (done) => {
      ...
      _chai2.default.request(_index2.default).post(adUrl).type('form').set('x-auth', token)
        .attach('img', _path2.default.join(loc, '/src/test/benz.jpg'))
    ...
    it('should return error 400 if there is no image', (done) => {
      ...
      _chai2.default.request(_index2.default).post(adUrl).set('x-auth', token).send(data)
        .end((err, res) => {
  ...
  describe('view available cars by manufacturer', () => {
    ...
    it('should return a custom error if no vehicle is found for the manufacturer', (done) => {
      carsArray();
      _chai2.default.request(_index2.default).get('/api/v1/car/manufacturer/Chidi').end((err, res) => {
  ...
  describe('Seller update ad price', () => {
    ...
    it('should return error 404 if ad is not found', () => {
      ...
      _chai2.default.request(_index2.default).patch(`/api/v1/car/${reqData.adId}`).set('x-auth', token).send(reqData)
        .end((err, res) => {
          expect(res.status).to.eq(404);
